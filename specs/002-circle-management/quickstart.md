...
4. Implement backend routes in this order: authenticated registered-user search and create, list/read/update/archive, public discovery/direct join, invite join/refresh, members/remove, then role changes. Reuse Feature 001 auth/session middleware and centralized route/error constants.
